    ...
    <main className="min-h-screen bg-black text-white bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#2D0A4E] via-black to-black flex items-center justify-center p-4">
      <div className="max-w-4xl w-full text-center space-y-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <Link href="/admin/flyer" className="group flex flex-col items-center justify-center gap-4 bg-[#161920]/80 backdrop-blur-sm border border-[#2D0A4E] hover:border-cyan-500 rounded-3xl p-8 hover:bg-[#1a1e26] transition-all duration-300 transform hover:-translate-y-2 hover:shadow-[0_10px_40px_rgba(34,211,238,0.3)] sm:col-span-2 lg:col-span-1">
            <div className="w-20 h-20 rounded-full bg-cyan-500/10 flex items-center justify-center border border-cyan-500/30 group-hover:bg-cyan-500/20 transition-colors">
              <span className="text-4xl">🖼️</span>
            </div>
            <div>
              <h2 className="text-2xl font-bold text-white mb-2">Generador de Flyers</h2>
              <p className="text-sm text-gray-400">Crea flyers personalizados para cada evento</p>
            </div>
          </Link>
        </div>
